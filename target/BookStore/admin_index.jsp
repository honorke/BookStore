		...
		<nav class="navbar-default navbar-static-side" role="navigation">
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a class="J_menuItem" href="BookTitle/give_wait.action"> <i
							class="fa fa-home"></i> <span class="nav-label">待发货</span>
					</a></li>
					<li><a class="J_menuItem" href="BookTitle/end_wait.action"> <i
							class="fa fa-home"></i> <span class="nav-label">已发货</span>
					</a></li>
					
					<li><a class="J_menuItem" href="BookTitle/admin_index.action"> <i
							class="fa fa-home"></i> <span class="nav-label">书籍管理</span>
					</a></li>
